    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-800 to-purple-900 dark:from-slate-900 dark:to-purple-950 p-6 sm:p-10">
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="flex gap-6 flex-col md:flex-row">
          {/* Quick Links Section */}
          <div className="glass-card p-8 bg-white/15 dark:bg-black/25 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-2xl shadow-xl md:flex-1">
